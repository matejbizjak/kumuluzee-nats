...
| kumuluzee.nats.servers.streams.template-owner   | java.lang.String                   |                                                                                                                                                         |
...
| kumuluzee.nats.servers.streams.consumers.max-expires        | java.time.Duration                      |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| kumuluzee.nats.servers.streams.consumers.inactive-threshold | java.time.Duration                      |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
| kumuluzee.nats.servers.streams.consumers.max-pull-waiting   | int                                     | Maximum waiting to pull a batch of messages???                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| kumuluzee.nats.servers.streams.consumers.max-batch          | int                                     | Maximum batch size for pull subscribers???                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| kumuluzee.nats.servers.streams.consumers.max-bytes          | int                                     | Maximum message size???                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
| kumuluzee.nats.servers.streams.consumers.headers-only       | boolean                                 |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
